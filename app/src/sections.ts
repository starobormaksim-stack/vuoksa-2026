...
export const SECTIONS: SectionDef[] = [
  ...
  /* Заказчик 08.08.2026, диктуя порядок разделов: «Отельные варианты или
     ...
     виден в меню, в панели и в оглавлении. Своё имя ляжет в `S.secTitles.stay`. */
  { id: 'stay', title: 'Проживание', icon: BedDouble },
 ...
 * «Дороги» — за это заказчик ругал 08.08.2026 (урок У-143). Поэтому здесь
 * именно последний денежный раздел, а не «Расходы»: пока «Логистика»
 * и «Проживание» стоят отдельными разделами, зачёт обязан быть за ними.
 * Когда они станут подразделами «Расходов», значение сменится на `buy`.
 */
export const LAST_MONEY_SECTION = 'stay'
