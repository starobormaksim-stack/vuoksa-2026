 ...
 *
 * У поездки по умолчанию это по-прежнему весь `seed-v2.json` — Вуокса живёт им.
 * У остальных поездок — только справочники: иначе в чужую поездку въехали бы
 * вещи, закупка и маршрут Вуоксы, и человек не понял бы, откуда они взялись.
 */
 ...
 * «приготовлено». Новая поездка собирается заново, и чужие галочки в ней
 * означали бы неправду. Это же написано словами на экране.
 */
