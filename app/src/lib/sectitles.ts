...
const KEY_OF: Record<string, string> = {
  ...
  gear: 'gear',
  buy: 'buy',
  /* ⛔ `log` — это «Логистика», и ключ пережил переезд. Раздела «Дорога»
     больше нет: 09.08.2026 логистика стала ПОДРАЗДЕЛОМ «Расходов», и своё
     название заказчика обязано было переехать вместе с ней. Если бы ключ
     исчез, подраздел назвался бы заводским словом, а имя, которое человек
     написал сам, осталось бы лежать в документе никому не видимым (У-160). */
  log: 'log',
  /* Ни «Аренды», ни «Проживания», ни «Вопросов» в первой версии отдельными
     листами не было, поэтому ключ совпадает с идентификатором: чужого имени,
     которое можно затереть, здесь нет. */
  rent: 'rent',
  stay: 'stay',
  menu: 'menu',
  ideas: 'ideas',
 ...
 *
 * Ключи здесь — те же, что в хранении (`KEY_OF`).
 */
