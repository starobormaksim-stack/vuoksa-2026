    ...
    <div className="mx-auto flex min-h-svh w-full max-w-[34rem] flex-col justify-center gap-6 px-4 py-10">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <p className="text-body leading-relaxed text-balance text-ink">
          {denied
            ? 'Ключ, с которым вы пришли, эта поездка не признала. Такое бывает, когда ' +
              'владелец поменял вам права: старая ссылка тогда гаснет.'
            : 'Поездку видит только её команда. Чтобы лист открылся, зайдите по своей ' +
              'личной ссылке — той, что прислал владелец.'}
        </p>
        ...
        {signedInAs && (
          <p className="text-note leading-relaxed text-balance text-muted">
            ...
            почты листу мало: он узнаёт владельца по его же личной ссылке. Откройте её
            целиком, вместе с ключом.
          </p>
        )}
      </div>
      ...
      <div className="flex flex-col gap-5 rounded-xl border border-line bg-surface p-4">
        ...
        <p className="text-note leading-relaxed text-muted">
          Ссылка задаёт права: кто по ней зашёл, тот и правит. Ключ в её конце —
          это и есть пропуск, поэтому пересылать ссылку посторонним не стоит.
        </p>
      </div>
