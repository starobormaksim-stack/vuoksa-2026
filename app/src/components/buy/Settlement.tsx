 ...
 *
 * ─── Почему блок живёт в «Закупке», а не в «Дороге» ───
 * Слово заказчика 05.08.2026: «все затраты закупки имеют отношение также
 * и к затратам, которые связаны с проездом, то есть бензин и так далее…
 * это всё должно быть в одном разделе, внизу должны быть итоги». Считался
 * блок всегда по ВСЕМ тратам поездки (закупка, топливо, аренда) — а стоял
 * в «Дороге», то есть искать его надо было там, где о нём не думают.
 * ⛔ Второго экземпляра в «Дороге» нет: один блок в одном месте (У-53).
 *
